    ...
    return (
        <div className='my-12 mx-3'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-12'>
                {
                    orders.map(order => <div className="shadow-xl p-6 rounded-lg font-semibold text-white" style={{ backgroundImage: `url(${order.serviceImg})`, backgroundRepeat: "no-repeat", textShadow: '4px 4px 8px #000000', backgroundSize: 'cover' }}>
